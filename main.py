...
from common.utils import load_storage, save_storage, extract_data_from_xml, create_job_posting_qualifier, get_gpt_answers_qualify
    ...
    for page in pages:
        ...
        for job_post in job_posts:
            if job_post.title.text not in open_storage:
                ...
                job_dict[title] = [url, job_posting_qualifier.description, posted_on]
